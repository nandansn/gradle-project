...
public class DragAndDropTest {
	...
	String url = "http://127.0.0.1:5500/telusko/dragndrop/dd2.html";
	String dipcUrl ="http://slc14xrm.us.oracle.com:20614/dicloud/app/mapping/edit/53a72b80-1f9a-11e9-8d66-2773bcdc2618";
...
*/		System.setProperty("webdriver.chrome.driver",
	...
	public void testOne() throws InterruptedException{
		...
		/*// wait for canvas to load and print the Source title
		System.out.println(driver.findElement(By.id("Source")).getAttribute("title"));
		
		System.out.println(driver.findElement(By.xpath("//*[@id='mappingDiagram']/*[local-name() = 'svg']/*[local-name() = 'g']/*[local-name() = 'g']//*[local-name() = 'rect']")).getAttribute("width"));
		*/
/*		WebElement from = driver.findElement(By.id("Source"));

		WebElement to = driver.findElement(By.xpath("//*[@id='mappingDiagram']/*[local-name() = 'svg']/*[local-name() = 'g']/*[local-name() = 'g']//*[local-name() = 'rect']"));
...
*/		
		...
		dragandDropAcion.moveToElement(from).clickAndHold().pause(2000).moveByOffset(to.getRect().getX() +20,to.getRect().getY()+15).release().build().perform();
		*/
