...
public class DataFlowDragNDropDataFlow {
	...
	public void openApp() throws InterruptedException {
		...
		/*driver.findElement(
				By.xpath("//div[contains(@class,'AppContainer-toolbarIcon')]//*[contains(@class,'MuiSvgIcon-root')]"))
				.click();
	...
	public void testSelenium() throws InterruptedException {
		...
		WebElement to = driver.findElement(By.id("dataFlowCanvas"));
	...
	@Test(enabled = true)
	public void testCanvasDragNDrop() throws InterruptedException {

		// document.cy.elements()[0].emit('cxttap', new MouseEvent('cxttap', {x:300, y:170, clientX: 378, clientY: 302})  );
		
		
		JavascriptExecutor js = (JavascriptExecutor) driver;
		String srcDrag = "document.cy.elements()[0].emit('cxttap', new MouseEvent('cxttap', {x:300, y:90, clientX: 378, clientY: 302})  );";
		...
		System.out.println(driver.findElement(By.xpath("//span[contains(text(),'Target')]")).getText());
	...
	public void testJavaScript() throws InterruptedException {
		...
		JavascriptExecutor js = (JavascriptExecutor) driver;
		String srcDrag = javaScript.replaceFirst("PAGE_X_LOCATION", "374").replace("PAGE_Y_LOCATION", "196");
		srcDrag = srcDrag.replaceFirst("SOURCE_NODE_LOCATION", "Source");
		js.executeScript(srcDrag);

		String exprDrag = javaScript.replaceFirst("PAGE_X_LOCATION", "474").replace("PAGE_Y_LOCATION", "196");
		exprDrag = exprDrag.replaceFirst("SOURCE_NODE_LOCATION", "Joiner");
		js.executeScript(exprDrag);

		String targetDrag = javaScript.replaceFirst("PAGE_X_LOCATION", "574").replace("PAGE_Y_LOCATION", "196");
		targetDrag = targetDrag.replaceFirst("SOURCE_NODE_LOCATION", "Target");
		js.executeScript(targetDrag);
	...
	@Test
	public void testEdgeCreation() throws InterruptedException {

		JavascriptExecutor js = (JavascriptExecutor) driver;
		String addDummyEdge = "document.cy.add({data:{id:'1234',source:document.cy.elements()[0].data().id,target:document.cy.elements()[1].data().id,group:'edges'}})";
		js.executeScript(addDummyEdge);

		TimeUnit.SECONDS.sleep(1);

		String triggerehComplete = "document.cy.trigger('ehcomplete',[document.cy.elements()[0],document.cy.elements()[1],document.cy.elements()[2]]);";
	...
	@Test
	public void addingFilterBetweenExistingSourceAndTarget() throws InterruptedException {
		...
		JavascriptExecutor js = (JavascriptExecutor) driver;
		String srcDrag = javaScript.replaceFirst("PAGE_X_LOCATION", "500").replaceFirst("PAGE_Y_LOCATION", "300");
		srcDrag = srcDrag.replaceFirst("SOURCE_NODE_LOCATION", "Filter");
		System.out.println(js);
		js.executeScript(srcDrag);

		TimeUnit.SECONDS.sleep(1);

		String addDummyEdgeSourceToFilter = "document.cy.add({data:{id:'1234',source:document.cy.elements()[0].data().id,target:document.cy.elements()[2].data().id,group:'edges'}})";
		js.executeScript(addDummyEdgeSourceToFilter);

		TimeUnit.SECONDS.sleep(1);

		String triggerehCompleteSourceToFilter = "document.cy.trigger('ehcomplete',[document.cy.elements()[0],document.cy.elements()[2],document.cy.elements()[3]]);";
		js.executeScript(triggerehCompleteSourceToFilter);

		TimeUnit.SECONDS.sleep(1);

		String addDummyEdgeFilterToTarget = "document.cy.add({data:{id:'12345',source:document.cy.elements()[2].data().id,target:document.cy.elements()[1].data().id,group:'edges'}})";
		js.executeScript(addDummyEdgeFilterToTarget);

		TimeUnit.SECONDS.sleep(1);

		String triggerehCompleteFilterToTarget = "document.cy.trigger('ehcomplete',[document.cy.elements()[2],document.cy.elements()[1],document.cy.elements()[4]]);";
		js.executeScript(triggerehCompleteFilterToTarget);

		TimeUnit.SECONDS.sleep(4);

		js = (JavascriptExecutor) driver;
		String scriptToTapSource = "document.cy.elements()[2].trigger('tap')";
		...
		driver.findElement(By.id("expressionCondition")).sendKeys("Filter Condition");
	...
	@Test
	public void addingExpressionBetweenExistingSourceAndTarget() throws InterruptedException {

		TimeUnit.SECONDS.sleep(4);

		JavascriptExecutor js = (JavascriptExecutor) driver;
		String srcDrag = javaScript.replaceFirst("PAGE_X_LOCATION", "500").replaceFirst("PAGE_Y_LOCATION", "300");
		srcDrag = srcDrag.replaceFirst("SOURCE_NODE_LOCATION", "Projection");
		System.out.println(js);
		js.executeScript(srcDrag);
		...
		driver.findElement(By.id("expressionCondition")).sendKeys("Expression Condition");
	...
	@Test
	public void addingJoinerBetweenSourcesAndTarget() throws InterruptedException {

		JavascriptExecutor js = (JavascriptExecutor) driver;
		String srcDrag = javaScript.replaceFirst("PAGE_X_LOCATION", "370").replaceFirst("PAGE_Y_LOCATION", "350");
		srcDrag = srcDrag.replaceFirst("SOURCE_NODE_LOCATION", "Source");
		System.out.println(js);
		js.executeScript(srcDrag);
		...
		js = (JavascriptExecutor) driver;
		srcDrag = javaScript.replaceFirst("PAGE_X_LOCATION", "500").replaceFirst("PAGE_Y_LOCATION", "350");
		srcDrag = srcDrag.replaceFirst("SOURCE_NODE_LOCATION", "Joiner");
		System.out.println(js);
		js.executeScript(srcDrag);

		js = (JavascriptExecutor) driver;
		String addDummyEdgeSource1ToJoiner = "document.cy.add({data:{id:'12341',source:document.cy.elements()[0].data().id,target:document.cy.elements()[3].data().id,group:'edges'}})";
		js.executeScript(addDummyEdgeSource1ToJoiner);

		TimeUnit.SECONDS.sleep(1);

		String triggerehCompleteSource1ToJoiner = "document.cy.trigger('ehcomplete',[document.cy.elements()[0],document.cy.elements()[3],document.cy.elements()[4]]);";
		js.executeScript(triggerehCompleteSource1ToJoiner);

		js = (JavascriptExecutor) driver;
		String addDummyEdgeSource2ToJoiner = "document.cy.add({data:{id:'12342',source:document.cy.elements()[2].data().id,target:document.cy.elements()[3].data().id,group:'edges'}})";
		js.executeScript(addDummyEdgeSource2ToJoiner);

		TimeUnit.SECONDS.sleep(1);

		String triggerehCompleteSource2ToJoiner = "document.cy.trigger('ehcomplete',[document.cy.elements()[2],document.cy.elements()[3],document.cy.elements()[5]]);";
		js.executeScript(triggerehCompleteSource2ToJoiner);

		js = (JavascriptExecutor) driver;
		String addDummyEdgeJoinerToTarget = "document.cy.add({data:{id:'12343',source:document.cy.elements()[3].data().id,target:document.cy.elements()[1].data().id,group:'edges'}})";
		js.executeScript(addDummyEdgeJoinerToTarget);

		TimeUnit.SECONDS.sleep(1);

		String triggerehCompleteTargetToJoiner = "document.cy.trigger('ehcomplete',[document.cy.elements()[3],document.cy.elements()[1],document.cy.elements()[6]]);";
		js.executeScript(triggerehCompleteTargetToJoiner);
		...
		driver.findElement(By.id("expressionCondition")).sendKeys("Joiner Condition");
	...
	@Test(enabled = true)
	public void testComplexFlow() throws InterruptedException {

		JavascriptExecutor js = (JavascriptExecutor) driver;
		String srcDrag = javaScript.replaceFirst("PAGE_X_LOCATION", "380").replace("PAGE_Y_LOCATION", "420");
		srcDrag = srcDrag.replaceFirst("SOURCE_NODE_LOCATION", "Source");
		js.executeScript(srcDrag);
		...
		js = (JavascriptExecutor) driver;
		String joinerDrag = javaScript.replaceFirst("PAGE_X_LOCATION", "490").replace("PAGE_Y_LOCATION", "420");
		joinerDrag = joinerDrag.replaceFirst("SOURCE_NODE_LOCATION", "Joiner");
		js.executeScript(joinerDrag);

		js = (JavascriptExecutor) driver;
		String filterDrag = javaScript.replaceFirst("PAGE_X_LOCATION", "590").replace("PAGE_Y_LOCATION", "420");
		filterDrag = filterDrag.replaceFirst("SOURCE_NODE_LOCATION", "Filter");
		js.executeScript(filterDrag);

		js = (JavascriptExecutor) driver;
		String srcDrag_3 = javaScript.replaceFirst("PAGE_X_LOCATION", "690").replace("PAGE_Y_LOCATION", "520");
		srcDrag_3 = srcDrag_3.replaceFirst("SOURCE_NODE_LOCATION", "Source");
		js.executeScript(srcDrag_3);

		js = (JavascriptExecutor) driver;
		String exprDrag = javaScript.replaceFirst("PAGE_X_LOCATION", "800").replace("PAGE_Y_LOCATION", "520");
		exprDrag = exprDrag.replaceFirst("SOURCE_NODE_LOCATION", "Projection");
		js.executeScript(exprDrag);

		js = (JavascriptExecutor) driver;
		String joinerDrag_2 = javaScript.replaceFirst("PAGE_X_LOCATION", "730").replace("PAGE_Y_LOCATION", "440");
		joinerDrag_2 = joinerDrag_2.replaceFirst("SOURCE_NODE_LOCATION", "Joiner");
		js.executeScript(joinerDrag_2);

		js = (JavascriptExecutor) driver;
		String joinerDrag_3 = javaScript.replaceFirst("PAGE_X_LOCATION", "900").replace("PAGE_Y_LOCATION", "520");
	...
	public static void testSourceProperties() throws InterruptedException {
		...
		// 1. Default is details, Enter Value for name.
		driver.findElement(By.cssSelector("#name")).clear();
		driver.findElement(By.cssSelector("#name")).sendKeys("Test_Source_1");
		TimeUnit.SECONDS.sleep(1);
